...
const TITLE       = 'インスタリールの伸ばし方完全ガイド｜アルゴリズム攻略と再生数を上げるコツ【2026年最新】';
const CATEGORY    = 'SNS戦略';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const LOGO_PATH = '/Users/andoaoi/out-2/old/images/fotter-logo.png';
...
async function main() {
  ...
  // microCMS Management API にアップロード
  ...
  if (!patchRes.ok) {
    ...
    // eyecatch が URL 文字列のみ受け付ける場合の fallback
  ...
  console.log(`   記事: https://www.cocomarke.com/blog/${ARTICLE_ID}/`);
}
